...
Cross-platform calendar access for [Skip](https://skip.dev) apps. SkipCalendar provides a unified Swift API for querying, creating, and updating calendar events on both iOS and Android.
